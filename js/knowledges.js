...
function createPost(post){
     ...
     var html = '<div class="mt-3 card border-left-success shadow"><div class="card-body"><div class="row no-gutters align-items-center"> <div class="col-xl-6">';
     ...
     html += '<button onclick="window.location=\'post.html?post='+ post.id +'\'" class="btn rounded-circle chevron-rounded border-0 text-success" id="newBtn"><i class="fas fa-chevron-right"></i></button>';
